[README.md](https://github.com/user-attachments/files/26860629/README.md)
# Karcsi's Projects
...
### 1. Grind Planner — `Index/` + `Grind Calculator/`
...
- The app itself: `Grind Calculator/calculator.html`
...
├── Index/
│   └── index.html                  # Grind Planner marketing page
├── Grind Calculator/
│   └── calculator.html             # the calculator app (self-contained)
├── Exifviewerproject/
│   ├── index.html                  # ExifViewer marketing page
│   ├── ExifViewer.xcodeproj/       # Xcode project
│   └── ExifViewer/                 # SwiftUI source
└── Photo Automation/
    ├── index.html                  # Photo Watcher marketing page
